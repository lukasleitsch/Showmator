...
echo '<span class="list">&lt;ul&gt;<br></span>';
    ...
    echo '<span class="list">&lt;li&gt;</span><span class="time">'.date("H:i:s", $value["time"]).'</span> '.($value["url"] == 'null' ? $value["title"].'<br>' : '&lta href="'.$value["url"].'"<span class="target"> target="_blank"</span>>'.$value["title"].'&lt/a&gt<span class="list">&lt;/li&gt;</span><br />'); 
